...
MACRO_CONFIG_STR(SvMotd, sv_motd, 900, "This is FM-FNG by Muaad based on Openfng by fisted", CFGFLAG_SERVER, "Message of the day to display for the clients")
...
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "FM", CFGFLAG_SERVER, "Game type (dm, tdm, ctf)")
